...
dvc exp run --queue -S "model=esm2_lora_contactconv_650m" -n "lora_conv_refiner_k5"
dvc exp run --queue -S "model=esm2_lora_contactconv_650m" -S "model.cnn_kernel_size=7" -n "lora_conv_refiner_k7"
dvc queue status